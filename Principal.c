...
void chuta(char chutes[], short *tentativas){
	char chute;
	printf("Qual letra? ");
	scanf(" %c", &chute);
...
int jachutou(char letra, char* chutes, short tentativas){
	short achou = 0;
...
void desenhaforca(char *palavrasecreta, char *chutes, short tentativas){
